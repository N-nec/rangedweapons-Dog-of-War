...
minetest.register_craftitem("rangedweapons:ammo", {
		description = "" ..core.colorize("#35cdff","Gun Ammo\n")..core.colorize("#FFFFFF", "Keep on you at all times."),
	stack_max = 10000,
	inventory_image = "rangedweapons_ammo.png",
})
