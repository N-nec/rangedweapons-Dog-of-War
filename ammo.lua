...
if moveresult.collisions[1].type == "object" --or object:get_player_name() ~= (self.owner)
...
moveresult.collisions[1].object:punch(owner, 1, {
...
minetest.register_craftitem("rangedweapons:9mm", {
	...
	RW_ammo_capabilities = {
		ammo_damage = {fleshy=8,knockback=0},
		ammo_critEffc = 0.25,
		ammo_crit = 1,
		ammo_velocity = 25,
...
minetest.register_craftitem("rangedweapons:357", {
	...
	RW_ammo_capabilities = {
		ammo_damage = {fleshy=20,knockback=0},
		ammo_critEffc = 0.6,
		ammo_crit = 3,
		ammo_velocity = 45,
		ammo_glass_breaking = 1,
...
minetest.register_craftitem("rangedweapons:50ae", {
	...
	RW_ammo_capabilities = {
		ammo_damage = {fleshy=40,knockback=0},
		ammo_critEffc = 0.9,
		ammo_crit = 6,
		ammo_velocity = 55,
		ammo_glass_breaking = 1,
...
minetest.register_craftitem("rangedweapons:556mm", {
	...
	RW_ammo_capabilities = {
		ammo_damage = {fleshy=15,knockback=0},
		ammo_critEffc = 0.4,
		ammo_crit = 2,
		ammo_velocity = 35,
		ammo_glass_breaking = 1,
...
minetest.register_craftitem("rangedweapons:408cheytac", {
	...
	RW_ammo_capabilities = {
		ammo_damage = {fleshy=50,knockback=0},
		ammo_critEffc = 0.8,
		ammo_crit = 5,
		ammo_velocity = 70,
		ammo_glass_breaking = 1,
...
OnCollision = function(player,bullet,target)
	tnt.boom(bullet.object:get_pos(), {damage_radius=5,radius=3})
end,
ammo_particles = {
...
minetest.register_craftitem("rangedweapons:rocket", {
	...
	RW_ammo_capabilities = {
		ammo_damage = {fleshy=100,knockback=0},
		ammo_critEffc = 1.0,
		ammo_crit = 1,
		ammo_velocity = 20,
		ammo_glass_breaking = 1,
